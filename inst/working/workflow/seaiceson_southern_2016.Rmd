...
If our repository has a matching number and date range of files, we can continue in confidence. 
...
Load the advance and retreat layers and calculate overall variability. 
